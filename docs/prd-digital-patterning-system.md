# Product Requirements Document: Millitron Digital Patterning System

## Document Control

- File name: `docs/prd-digital-patterning-system.md`
...
The **Millitron Digital Patterning System** is a proprietary industrial software platform that controls and monitors
...
Floorcovering development engineers at facilities like Milliken & Company routinely context-switch across six or more
...
reduce this friction. This workshop demonstrates those capabilities using a realistic Millitron scenario:
...
- Demonstrate GitHub Copilot Agentic DevOps workflows across the full Millitron technology stack.
...
| --- | --- | --- | --- |
| FR-001 | The system shall simulate a Millitron pattern engine with configurable dye-head count (default: 16) and pattern width (default: 1024 px) | Must | Simulation stub; FPGA module is a future extension |
...
| 2026-05-14 | Use FPGA VHDL stubs (not behavioral C++) | VHDL is the actual Millitron signal-processing language | Engineering lead |
...
- **Related infographic:** [docs/images/millitron-infographic.svg](images/millitron-infographic.svg)
...
- **Glossary:**
  - **Millitron** — Milliken & Company's proprietary digital textile patterning machine
